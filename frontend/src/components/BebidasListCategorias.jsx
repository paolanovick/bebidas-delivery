// src/components/BebidasListCategorias.jsx
...
const BebidasListCategorias = ({
  ...
  // Obtener categorías de una bebida (array)
  ...
  // Todas las categorías únicas (para pestañas)
  ...
  // Asegurar que siempre haya una categoría activa válida
  useEffect(() => {
